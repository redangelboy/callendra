    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--callendra-text-secondary)] text-sm mt-2">Sign in to your account</p>
        </div>
        <div className="border border-[var(--callendra-border)] rounded-2xl p-8 flex flex-col gap-4">
          ...
          <p className="text-center text-sm text-[var(--callendra-text-secondary)] opacity-80">
            ...
            <a href="/en/register" className="text-[var(--callendra-text-primary)] hover:underline">Get started</a>
          </p>
        </div>
      </div>
    </main>
