...
/** Same URL flags as before: ?embed=1 or ?widget=1 */
...
/** Fills the screen; no page scroll — inner panel scrolls (like display). */
const viewportShell =
...
function BookPageInner() {
  ...
  /** Wider on large screens so multi-column grids have room (scroll inside step panel stays). */
  const contentMaxW = "w-full max-w-lg sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl";

  /** 2–4 columns on larger breakpoints; narrow phones stay 2 cols for time chips. */
